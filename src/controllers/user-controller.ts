...
import { ISignUpBody, ISignInBody } from "../interfaces";
...
const signUp: RequestHandler<unknown, unknown, ISignUpBody, unknown> = async (
  req,
  res,
  next
) => {
...
const signIn: RequestHandler<unknown, unknown, ISignInBody, unknown> = async (
  req,
  res,
  next
) => {
